      ...
      <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
        <div
          style={{
            ...
            borderRadius: 8,
            flexShrink: 0,
            background: cor.badgeBg,
            color: cor.badgeColor,
            display: "flex",
            alignItems: "center",
          ...
          <div style={{ display: "flex", gap: 12, marginTop: 8, flexWrap: "wrap" }}>
            {insight.diasAusente != null && (
              <span style={{ fontSize: 11, color: T.textDim }}>
                ausente há{" "}
                <strong style={{ color: insight.diasAusente > 30 ? T.red : T.textMid }}>
                  {insight.diasAusente}d
                </strong>
              </span>
            )}
...
Clientes em risco: ${
        clientes
          ...
          .map((c) => `${c.nome} (${c.diasAusente}d ausente)`)
          .join(", ") || "nenhum"
      }.`.trim()
    : "";
  ...
  async function perguntar(q) {
    ...
    try {
      const r = await chamarIA(
        `Você é um consultor especialista em retenção de clientes para pequenos negócios brasileiros, trabalhando para "${
          config?.empresaNome || "esta empresa"
        }".
        ...
        >
          ...
          <tbody>
            {sorted.map((c, i) => (
              ...
              >
                {/* BUG FIX 3: onClick adicionado no <td> correto */}
                <td
                ...
                <td
                  style={{
                    padding: "12px 14px",
                    fontWeight: 600,
                    color: c.diasAusente > 30 ? T.red : T.textMid,
                    whiteSpace: "nowrap",
                  }}
                >
        ...
        >
          ...
          <div style={{ display: "flex", gap: "15px", marginTop: "10px" }}>
            <span style={{ fontSize: "12px", color: T.textMid }}>
              LTV: <b style={{ color: T.green }}>{formatarReal(faturamentoTotal)}</b>
            </span>
            <span style={{ fontSize: "12px", color: T.textMid }}>
          ...
          {historico.map((v, i) => (
            ...
            >
              ...
              >
                ...
                <span style={{ fontSize: "13px", fontWeight: "700", color: T.gold }}>
                  {formatarReal(v.total)}
                </span>
              </div>
...
export default function App() {
  ...
  // BUG FIX 1: useState declarado no topo do componente, fora do JSX
  ...
  // BUG FIX 2: dadosBrutos desestruturado para o modal ter acesso às vendas
    ...
    return (
      <div
        style={{
          ...
          height: "100vh",
          fontSize: 13,
          color: TEMAS.dark.textMid,
          background: TEMAS.dark.bg,
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: 10, color: T.textDim, marginTop: 2, letterSpacing: "0.06em" }}>
              via Assent Gestão
            </div>
          </div>
          ...
          {!bp.isMobile && (
            <button
              ...
              style={{
                ...
                color: T.textMid,
                flexShrink: 0,
                marginLeft: sidebarAberta ? 8 : "auto",
              }}
            >
              {sidebarAberta ? "←" : "→"}
            </button>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  width: "100%",
                  padding: mostrarLabel ? "9px 12px" : "10px",
                  borderRadius: 7,
                  marginBottom: 2,
                  border: "none",
              ...
              >
                <span style={{ color: ativo ? T.gold : T.textDim, fontSize: 14, flexShrink: 0 }}>
                  {a.icon}
                </span>
                {mostrarLabel && (
      ...
      >
        ...
        <div
          style={{
            padding: bp.isMobile ? "12px 16px" : "14px 24px",
            borderBottom: `1px solid ${T.border}`,
            background: T.surface,
            display: "flex",
            justifyContent: "space-between",
        ...
        <div
          style={{
            flex: 1,
            overflowY: "auto",
            padding: bp.isMobile ? "16px 14px" : "22px 24px",
            paddingBottom: bp.isMobile ? "72px" : "22px",
          }}
        >
          {/* ── Radar ── */}
          {aba === "radar" && (
            <>
              ...
              {insights.length === 0 ? (
                ...
                insights.map((ins) => (
                  <InsightCard key={ins.id} insight={ins} empresaNome={config?.empresaNome} T={T} />
                ))
              )}
            </>
          )}
          ...
          {/* ── IA ── */}
          {aba === "ia" && (
            <AssistenteIA metricas={metricas} clientes={clientes} config={config} T={T} />
          )}
