...
function MetricCard({ val, label, color, T }) {
  return (
    <div style={{
      ...
      <div style={{
        fontSize: 10, color: T.textMid, marginTop: 6,
...
function InsightCard({ insight, empresaNome, T }) {
  ...
  return (
    <div style={{
      ...
      {msg && (
        <div style={{
          marginTop: 12, background: T.surfaceAlt, borderRadius: 8,
          padding: "12px 14px", border: `1px solid ${T.borderAlt}`,
        }}>
          <p style={{
...
const clientesFiltrados = clientes.filter((c) => {
  ...
  // Largura real da sidebar conforme estado e breakpoint
    ...
    <div style={{
          ...
          {(sidebarAberta || bp.isMobile) ? (
            <>
              ...
              <button
                ...
                style={{
                  marginTop: 4, fontSize: 10, color: T.textDim, background: "none",
                  border: `1px solid ${T.border}`, cursor: "pointer",
                  padding: "5px 10px", borderRadius: 5, fontFamily: "inherit",
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", minWidth: 0 }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, minWidth: 0 }}>
            ...
            <div style={{ minWidth: 0 }}>
              <div style={{
                fontSize: bp.isMobile ? 14 : 16, fontWeight: 700,
        ...
        <div style={{
          ...
          // espaço pro bottom nav em mobile
          paddingBottom: bp.isMobile ? "72px" : (bp.isMobile ? "16px" : "22px"),
        }}>
          ...
          {aba === "radar" && (
            <>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
                <span style={{ fontSize: 10, fontWeight: 700, color: T.textDim, letterSpacing: "0.12em", textTransform: "uppercase", whiteSpace: "nowrap" }}>
            ...
            <>
              ...
              <div style={{
                ...
                <div style={{ background: T.surface, border: `1px solid ${T.border}`, borderRadius: 10, padding: 18 }}>
                  <p style={{ fontSize: 10, fontWeight: 700, color: T.textDim, marginBottom: 14, letterSpacing: "0.1em", textTransform: "uppercase" }}>
